...
\033[1;92m/_/    ██║   ╚██████╔╝██║  ██║██║  ██║      
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97mTOHA \033[1;92m           | 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97m T　O　 H　A　ツ \033[1;92m     |   
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-open https://www.facebook.com/profile.php?id=100055743736170&mibextid=ZbWKwL')
       main()  
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio TOHA_OK.mp3")
                print('\033[1;92m[TOHA-OK] '+uid+' | '+ps+'\033[0;97m')
